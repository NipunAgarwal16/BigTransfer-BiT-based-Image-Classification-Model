...
class ResnetV2(tf.keras.Model):
    ...
    def _create_root_block(
        self, num_filters, conv_size=7, conv_stride=2, pool_size=3, pool_stride=2
    ):
        layers = [
...
NUM_UNITS = {
    k: (3, 4, 6, 3) if "R50" in k else (3, 4, 23, 3) if "R101" in k else (3, 8, 36, 3)
